- view: f_virtual_component_metrics
  sql_table_name: public.f_Virtual_ComponentMetrics
  fields:
  ...
  - dimension: backplane_utilization_pctile05
    type: number
    sql: ${TABLE}."Backplane Utilization (pctile05)"

  - dimension: backplane_utilization_pctile90
    type: number
    sql: ${TABLE}."Backplane Utilization (pctile90)"

  - dimension: backplane_utilization_pctile95
    type: number
    sql: ${TABLE}."Backplane Utilization (pctile95)"

  - dimension: backplane_utilization_pctile99
    type: number
    sql: ${TABLE}."Backplane Utilization (pctile99)"
  ...
  - dimension: buffer_failure_rate_pctile05
    type: number
    sql: ${TABLE}."Buffer Failure Rate (pctile05)"

  - dimension: buffer_failure_rate_pctile90
    type: number
    sql: ${TABLE}."Buffer Failure Rate (pctile90)"

  - dimension: buffer_failure_rate_pctile95
    type: number
    sql: ${TABLE}."Buffer Failure Rate (pctile95)"

  - dimension: buffer_failure_rate_pctile99
    type: number
    sql: ${TABLE}."Buffer Failure Rate (pctile99)"
  ...
  - dimension: buffer_miss_rate_pctile05
    type: number
    sql: ${TABLE}."Buffer Miss Rate (pctile05)"

  - dimension: buffer_miss_rate_pctile90
    type: number
    sql: ${TABLE}."Buffer Miss Rate (pctile90)"

  - dimension: buffer_miss_rate_pctile95
    type: number
    sql: ${TABLE}."Buffer Miss Rate (pctile95)"

  - dimension: buffer_miss_rate_pctile99
    type: number
    sql: ${TABLE}."Buffer Miss Rate (pctile99)"
  ...
  - dimension: buffer_no_memory_rate_pctile05
    type: number
    sql: ${TABLE}."Buffer NoMemory Rate (pctile05)"

  - dimension: buffer_no_memory_rate_pctile90
    type: number
    sql: ${TABLE}."Buffer NoMemory Rate (pctile90)"

  - dimension: buffer_no_memory_rate_pctile95
    type: number
    sql: ${TABLE}."Buffer NoMemory Rate (pctile95)"

  - dimension: buffer_no_memory_rate_pctile99
    type: number
    sql: ${TABLE}."Buffer NoMemory Rate (pctile99)"
  ...
  - dimension: buffer_utilization_pctile05
    type: number
    sql: ${TABLE}."Buffer Utilization (pctile05)"

  - dimension: buffer_utilization_pctile90
    type: number
    sql: ${TABLE}."Buffer Utilization (pctile90)"

  - dimension: buffer_utilization_pctile95
    type: number
    sql: ${TABLE}."Buffer Utilization (pctile95)"

  - dimension: buffer_utilization_pctile99
    type: number
    sql: ${TABLE}."Buffer Utilization (pctile99)"
  ...
  - dimension: cpu_1min_utilization_pctile05
    type: number
    sql: ${TABLE}."CPU 1min Utilization (pctile05)"

  - dimension: cpu_1min_utilization_pctile90
    type: number
    sql: ${TABLE}."CPU 1min Utilization (pctile90)"

  - dimension: cpu_1min_utilization_pctile95
    type: number
    sql: ${TABLE}."CPU 1min Utilization (pctile95)"

  - dimension: cpu_1min_utilization_pctile99
    type: number
    sql: ${TABLE}."CPU 1min Utilization (pctile99)"
  ...
  - dimension: cpu_5min_utilization_pctile05
    type: number
    sql: ${TABLE}."CPU 5min Utilization (pctile05)"

  - dimension: cpu_5min_utilization_pctile90
    type: number
    sql: ${TABLE}."CPU 5min Utilization (pctile90)"

  - dimension: cpu_5min_utilization_pctile95
    type: number
    sql: ${TABLE}."CPU 5min Utilization (pctile95)"

  - dimension: cpu_5min_utilization_pctile99
    type: number
    sql: ${TABLE}."CPU 5min Utilization (pctile99)"
  ...
  - dimension: cpu_5sec_utilization_pctile05
    type: number
    sql: ${TABLE}."CPU 5sec Utilization (pctile05)"

  - dimension: cpu_5sec_utilization_pctile90
    type: number
    sql: ${TABLE}."CPU 5sec Utilization (pctile90)"

  - dimension: cpu_5sec_utilization_pctile95
    type: number
    sql: ${TABLE}."CPU 5sec Utilization (pctile95)"

  - dimension: cpu_5sec_utilization_pctile99
    type: number
    sql: ${TABLE}."CPU 5sec Utilization (pctile99)"
  ...
  - dimension: disk_space_free__mb_pctile05
    type: number
    sql: ${TABLE}."Disk Space Free - MB (pctile05)"

  - dimension: disk_space_free__mb_pctile90
    type: number
    sql: ${TABLE}."Disk Space Free - MB (pctile90)"

  - dimension: disk_space_free__mb_pctile95
    type: number
    sql: ${TABLE}."Disk Space Free - MB (pctile95)"

  - dimension: disk_space_free__mb_pctile99
    type: number
    sql: ${TABLE}."Disk Space Free - MB (pctile99)"
  ...
  - dimension: disk_space_total__mb_pctile05
    type: number
    sql: ${TABLE}."Disk Space Total - MB (pctile05)"

  - dimension: disk_space_total__mb_pctile90
    type: number
    sql: ${TABLE}."Disk Space Total - MB (pctile90)"

  - dimension: disk_space_total__mb_pctile95
    type: number
    sql: ${TABLE}."Disk Space Total - MB (pctile95)"

  - dimension: disk_space_total__mb_pctile99
    type: number
    sql: ${TABLE}."Disk Space Total - MB (pctile99)"
  ...
  - dimension: disk_space_used__mb_pctile05
    type: number
    sql: ${TABLE}."Disk Space Used - MB (pctile05)"

  - dimension: disk_space_used__mb_pctile90
    type: number
    sql: ${TABLE}."Disk Space Used - MB (pctile90)"

  - dimension: disk_space_used__mb_pctile95
    type: number
    sql: ${TABLE}."Disk Space Used - MB (pctile95)"

  - dimension: disk_space_used__mb_pctile99
    type: number
    sql: ${TABLE}."Disk Space Used - MB (pctile99)"
  ...
  - dimension: disk_space_utilization_pctile05
    type: number
    sql: ${TABLE}."Disk Space Utilization (pctile05)"

  - dimension: disk_space_utilization_pctile90
    type: number
    sql: ${TABLE}."Disk Space Utilization (pctile90)"

  - dimension: disk_space_utilization_pctile95
    type: number
    sql: ${TABLE}."Disk Space Utilization (pctile95)"

  - dimension: disk_space_utilization_pctile99
    type: number
    sql: ${TABLE}."Disk Space Utilization (pctile99)"
  ...
  - dimension: free_memory_pctile05
    type: number
    sql: ${TABLE}."Free Memory (pctile05)"

  - dimension: free_memory_pctile90
    type: number
    sql: ${TABLE}."Free Memory (pctile90)"

  - dimension: free_memory_pctile95
    type: number
    sql: ${TABLE}."Free Memory (pctile95)"

  - dimension: free_memory_pctile99
    type: number
    sql: ${TABLE}."Free Memory (pctile99)"
  ...
  - dimension: icmp_response_time_milliseconds_pctile05
    type: number
    sql: ${TABLE}."ICMP ResponseTime (Milliseconds) (pctile05)"

  - dimension: icmp_response_time_milliseconds_pctile90
    type: number
    sql: ${TABLE}."ICMP ResponseTime (Milliseconds) (pctile90)"

  - dimension: icmp_response_time_milliseconds_pctile95
    type: number
    sql: ${TABLE}."ICMP ResponseTime (Milliseconds) (pctile95)"

  - dimension: icmp_response_time_milliseconds_pctile99
    type: number
    sql: ${TABLE}."ICMP ResponseTime (Milliseconds) (pctile99)"
  ...
  - dimension: memory_utilization_pctile05
    type: number
    sql: ${TABLE}."Memory Utilization (pctile05)"

  - dimension: memory_utilization_pctile90
    type: number
    sql: ${TABLE}."Memory Utilization (pctile90)"

  - dimension: memory_utilization_pctile95
    type: number
    sql: ${TABLE}."Memory Utilization (pctile95)"

  - dimension: memory_utilization_pctile99
    type: number
    sql: ${TABLE}."Memory Utilization (pctile99)"
  ...
  - dimension: node_availability_pctile05
    type: number
    sql: ${TABLE}."Node Availability (pctile05)"

  - dimension: node_availability_pctile90
    type: number
    sql: ${TABLE}."Node Availability (pctile90)"

  - dimension: node_availability_pctile95
    type: number
    sql: ${TABLE}."Node Availability (pctile95)"

  - dimension: node_availability_pctile99
    type: number
    sql: ${TABLE}."Node Availability (pctile99)"
  ...
  - dimension: node_reachability_pctile05
    type: number
    sql: ${TABLE}."Node Reachability (pctile05)"

  - dimension: node_reachability_pctile90
    type: number
    sql: ${TABLE}."Node Reachability (pctile90)"

  - dimension: node_reachability_pctile95
    type: number
    sql: ${TABLE}."Node Reachability (pctile95)"

  - dimension: node_reachability_pctile99
    type: number
    sql: ${TABLE}."Node Reachability (pctile99)"
