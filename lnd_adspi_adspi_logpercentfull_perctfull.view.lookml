- view: lnd_adspi_adspi_logpercentfull_perctfull
  sql_table_name: public.LND_ADSPI_ADSPI_LOGPERCENTFULL_PERCTFULL
  fields:
  ...
  - dimension: log_file_disk_percent_full
    type: number
    sql: ${TABLE}.LogFileDiskPercentFull
