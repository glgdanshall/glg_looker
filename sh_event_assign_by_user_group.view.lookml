- view: sh_event_assign_by_user_group
  sql_table_name: public.SH_Event_AssignByUserGroup
  fields:

  - dimension: avg_events_closed_per_user
    type: number
    sql: ${TABLE}.AvgEvents_ClosedPerUser

  - dimension: backlog_over_load
    type: number
    sql: ${TABLE}.BacklogOverLoad
