- view: sd_dbmssql_sqlperformance
  sql_table_name: public.SD_DBMSSQL_SQLPerformance
  fields:
  ...
  - dimension: max_batch_requests_rate_count
    type: number
    sql: ${TABLE}.maxBatchRequestsRateCount

  - dimension: max_cpuused_percent
    type: number
    sql: ${TABLE}.maxCPUUsedPercent

  - dimension: max_current_avg_latch_wait_time
    type: number
    sql: ${TABLE}.maxCurrentAvgLatchWaitTime

  - dimension: max_extnts_allctin_rate_count
    type: number
    sql: ${TABLE}.maxExtntsAllctinRateCount

  - dimension: max_full_scan_rate_count
    type: number
    sql: ${TABLE}.maxFullScanRateCount

  - dimension: max_index_search_rate_count
    type: number
    sql: ${TABLE}.maxIndexSearchRateCount

  - dimension: max_latch_avg_wait_time
    type: number
    sql: ${TABLE}.maxLatchAvgWaitTime

  - dimension: max_latch_waits_rate_count
    type: number
    sql: ${TABLE}.maxLatchWaitsRateCount

  - dimension: max_page_allocated_rate_count
    type: number
    sql: ${TABLE}.maxPageAllocatedRateCount

  - dimension: max_pages_split_rate_count
    type: number
    sql: ${TABLE}.maxPagesSplitRateCount

  - dimension: max_read_write_errors_count
    type: number
    sql: ${TABLE}.maxReadWriteErrorsCount

  - dimension: max_rwpckt_errrs_count
    type: number
    sql: ${TABLE}.maxRWPcktErrrsCount

  - dimension: max_tbl_lck_escltn_rate_count
    type: number
    sql: ${TABLE}.maxTblLckEscltnRateCount

  - dimension: min_cpuused_percent
    type: number
    sql: ${TABLE}.minCPUUsedPercent

  - dimension: min_read_write_errors_count
    type: number
    sql: ${TABLE}.minReadWriteErrorsCount

  - dimension: min_rwpckt_errrs_count
    type: number
    sql: ${TABLE}.minRWPcktErrrsCount
