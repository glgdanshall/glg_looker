- view: lnd_adspi_adspi_logqueuelength_queue
  sql_table_name: public.LND_ADSPI_ADSPI_LOGQUEUELENGTH_QUEUE
  fields:
  ...
  - dimension: log_fiel_disk_queue_length
    type: number
    sql: ${TABLE}.LogFielDiskQueueLength
