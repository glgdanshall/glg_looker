view: sd_dbmssql_sqlconn_summary {
  sql_table_name: public.SD_DBMSSQL_SQLConnSummary ;;
  ...
  dimension: max_active_to_connected_percent {
    type: number
    sql: ${TABLE}.maxActiveToConnectedPercent ;;
  }
  ...
  dimension: max_suspectable_dbcount {
    type: number
    sql: ${TABLE}.maxSuspectableDBCount ;;
  }
  ...
  dimension: min_active_to_connected_percent {
    type: number
    sql: ${TABLE}.minActiveToConnectedPercent ;;
  }
